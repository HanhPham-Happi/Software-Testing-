...
public class HomeScreen {
	...
	public static String USERNAME_LABEL_XPATH 	= "(//a[@data-bs-toggle='dropdown'])[7]";
	public static String PROFILE_LINK_XPATH		= "(//a[@class='dropdown-item nav-link text-black'])[1]";
	...
	public static void logout(WebDriver driver) throws Exception {
		Helper.clickItem(driver, USERNAME_LABEL_XPATH);
		Helper.clickItem1(driver, LOGOUT_LINK_XPATH);
		Helper.assertElementDisplayed(driver, LOGIN_BTN_XPATH);
	}
